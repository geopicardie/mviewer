...
var getText = function(feature, resolution, label_field='name') {
        var type = 'Normal';
        var maxResolution = 75;
        var text = feature.get(label_field);
...
var createTextStyle = function(feature, resolution, label_field) {
  var align = 'Center';
  var baseline = 'Middle';
  var size = '10px';
  var offsetX = 15;
  ...
  return new ol.style.Text({
    ...
    font: font,
    text: getText(feature, resolution, label_field),
...
mviewer.featureStyles.eple_surete = function(feature, resolution) {
  if (resolution > 35) return '';

  var fillcolor = '#336699';
  switch(feature.get('STATUT')) {
    case 'LPO':
    case 'LP':
      fillcolor = '#336699';
      break;
  ...
  return [new ol.style.Style({
    image: new ol.style.Circle({
     ...
     text: createTextStyle(feature, resolution, 'ETIQUETTE')
  })];
};

mviewer.featureStyles.eple_surete_emprise = function(feature, resolution) {
  if (resolution < 35) return '';
